...
public class LlmIntegration {
    ...
    private static final String COMPRESSION_SYSTEM_PROMPT_ID =
            ...
            + "【Length Control】\n"
            + "10. Strict length limit: the output MUST be 60%~70% of the original length.\n"
            + "11. If the first draft is longer than 70%, delete more fillers, repetition, weak modifiers, and non-essential wording until it is within 60%~70%.\n"
            + "12. If the first draft is shorter than 60%, restore only essential factual wording until it is within 60%~70%.\n"
