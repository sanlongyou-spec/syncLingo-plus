...
public class LlmIntegration {
    ...
    private static final String COMPRESSION_SYSTEM_PROMPT_ID =
            ...
            + "【Length Control】\n"
            + "10. Strict length limit: the output MUST be 70%~80% of the original length.\n"
            + "11. If the first draft is longer than 80%, delete more fillers, repetition, weak modifiers, and non-essential wording until it is within 70%~80%.\n"
            + "12. If the first draft is shorter than 70%, restore only essential factual wording until it is within 70%~80%.\n"
            + "13. Do NOT delete key actions or events.\n\n"
            + "【Style (Strict)】\n"
