# syncLingo-plus Claude Instructions
...
- `.claude/skills/synclingo-coding-standards/SKILL.md`
- `.claude/skills/synclingo-coding-standards/references/comprehensive-testing.md`
